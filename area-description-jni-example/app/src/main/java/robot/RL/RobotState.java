...
import robot.tango.TangoJNINative;
...
public class RobotState {
    ...
    public void setAction(String command) {
        ...
        int motorpowers[] = new int[2];
        int i = 0;
        while (m.find()) {
            motorpowers[i++] = Integer.parseInt(m.group());
            Log.v("Motors", m.group() + " " + motorpowers[i - 1]);
        }
        motorLeftAction = motorpowers[0];
        motorRightAction = motorpowers[1];
    }
